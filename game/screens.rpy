...
screen navigation():
    ...
    if renpy.get_screen("main_menu"):
        ...
        hbox:
            ...
            textbutton _("CORTE") action Quit("about")

            if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):

                ## Help isn't necessary or relevant to mobile devices.
                textbutton _("Marduk Studio") action Help("https://mardukstudio.web.app/") 
        ...
        vbox:
            ...
            if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
                ...
                ## Help isn't necessary or relevant to mobile devices.
                textbutton _("Marduk Studio") action ShowMenu("help")
...
screen main_menu():
    ...
    on "show" action Play ("movie", "videos/main_menu.webm", loop=True)
